...
class BlockCoPolymerTDLG(gym.Env, erl.ExaEnv):
    ...
    def __init__(self, env_comm):
        ...
        cfg_file='./envs/env_vault/env_cfg/tdlg_setup.json'
        data = []
    ...
    def _run_TDLG(self):
        ...
        ## Run model state ##
        print ("app: ", self.app)
        env_out = subprocess.Popen([self.app], stdout=subprocess.PIPE, stderr=subprocess.STDOUT, cwd=self.worker_dir)#,env={'OMP_NUM_THREADS':
    ...
    def _render(self):
        ...
        self.fig = make_subplots(rows=2,
                                 ...
                                 specs=[[{'type': 'scatter','colspan':3},{},{}, {'type': 'volume','colspan':3},{},{}],
