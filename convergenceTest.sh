...
resultsDir="/people/suet688/exaLearn/ExaRL/results/convergenceTest3/"
...
partition="slurm"
extra_slurm_args="-x node42,node24"
numNodes=1
max_episode=5000
max_step=100
env="--env CartPole-v0"

base_batch_size=( 32 128 256 512 )
...
do
    for ba in "${batch_step_frequency[@]}"
    do
        ...
        do
            ...
            do
                ...
                do
                    ...
                    command="srun -N $numNodes -n ${r} $extra_slurm_args python ./exarl/driver ${profile} --output_dir ${resultsDir}/async_${ep}_${ba}_${r}_${t}_${batch_size} --workflow async --episode_block \"${ep}\" --batch_step_frequency ${ba} --train_frequency ${t} --n_episodes $max_episode --n_steps $max_step --batch_size $batch_size $env &> ${resultsDir}/async_${ep}_${ba}_${r}_${t}_${batch_size}.txt &"
                    echo "$command"
                    ./bsuite/throttle.pl $partition "$command" 20
