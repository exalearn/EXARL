...
# Intercommunicator to the parent MPI process
...
if __name__ == "__main__":
    ...
    # Store received parent id in an integer variable
    parent_id = np.array(0,dtype='i')

    # Receive broadcast from parents
    parent_comm.Bcast([parent_id, MPI.INT], root=0)

    ##
    print("I am spawned child " + str(rank) + " of parent " + str(parent_id))
