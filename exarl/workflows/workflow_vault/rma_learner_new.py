...
class RMA_NEW(erl.ExaWorkflow):
    ...
    def learner(self, workflow, learner_counter, episode_const, epsilon_const, ind_loss_buffer, model_buff, batch_data_exchange, agent_data):
        ...
        while True:
            ...
            sum_process_has_data = ExaComm.learner_comm.allreduce(process_has_data, op=MPI.SUM)
    ...
    def run(self, workflow):
        ...
        if ExaComm.is_agent():
            ...
            if self.use_priority_replay:
                ...
                ind_loss_buffer = self.ind_loss_data_structure(ExaComm.agent_comm, indicies_and_loss_for_size, rank_mask=ExaComm.is_actor(),
